 ...
 * valori distinti, restituisce true se e solo se gli elementi di W sono una sotto-sequenza inversa degli elementi di V, cio�  
...
public class Appello_20110905 {

	public static void main(String[] args) {
		int[] w = { 5, 6, 1, 4, 9, 2, 8, 7 };
		int[] v = { 0, 4, 6, 5 };
		if (sottosequenzainversa(w, v))
			System.out.println("il metodo e' verificato");
		else
			System.out.println("il metodo non e' verificato");
	}
