...
orizzontalmente) - cio�	due	elementi	adiacenti	 sulla	 stessa	 riga	 M[i][j]	 e	 M[i][j+1]	sono accorpabili	
orizzontalmente	se	M[i][j]	=	M[i][j+1];
� hanno	 lo	 stesso	 valore,sono adiacenti	e si trovano sulla stessa colonna (accorpabili verticalmente) - cio� due	
elementi	adiacenti	sulla	stessa	colonna	M[i][j]	e	M[i+1][j]	sono	accorpabili	verticalmente	se	M[i][j]	=	M[i+1][j].
Il	guadagno associato	a	due	elementi accorpabili � definito	come somma dei	loro valori - cio�	il	doppio	del	valore	di	
...
associati	a	tutte	le	coppie	di	elementi accorpabili orizzontalmente � maggiore	della	somma dei	guadagni associati	a	
