...
public class Appello_20130129 {

	public static void main(String[] args) {
		int[][] M = { { 0, 1, 0, 2, 1, 1, 0 }, { 0, 1, 0, 2, 1, 1, 2 }, { 1, 1, 2, 2, 1, 1, 2 },
				{ 1, 0, 2, 1, 0, 0, 2 }, { 1, 2, 1, 1, 2, 0, 2 }, { 2, 2, 0, 0, 2, 2, 2 } };
		...
		System.out.println();
		boolean p = aggiungiAttivita(M, 0, 3);
		System.out.print(p);
		System.out.println();
		int[] V = { 2, 2, 0, 1, 1, 2 };
		int[][] N = aggiungi(M, V);
	...
	public static boolean aggiungiAttivita(int[][] M, int i, int j) {
		if (M[i][j] == 0) {
			return true;
		}
		return false;
